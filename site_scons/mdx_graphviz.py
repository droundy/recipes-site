...
class GraphvizPreprocessor(markdown.preprocessors.Preprocessor):
    ...
    def __init__ (self, graphviz):
        ...
        self.formatters = ["dot", "neato", "lefty", "dotty", "twopi", "fdp", "circo", "osage"]
    ...
    def graph(self, n, type, lines):
        ...
        return r"""<img style="display:block;max-width:100%%;margin-left:auto;margin-right:auto;"
                        alt="Graphviz chart %s" src="%s" />""" % (n, output_path[4:])
        return r"""<img class=".pure-img"
                        alt="Graphviz chart %s" src="%s" />""" % (n, output_path)
